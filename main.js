...
function btnClicked() {
  ...
  if (scoreCounter < 5) {
    btn.innerHTML = "Retry";
    msg.innerHTML =
      "would you like to give to give the incorrect answers another try?";
  } else {
  ...
  document
    ...
    .addEventListener("click", rtryBtnClicked);
...
// let containerEl = document.getElementById("div");
// let divEl = document.createElement("div");
// divEl.innerHTML = `<p>How many continents and oceans are there?</p> <p><input id="qnOne" type="text"></p> <p id="feedback1" ></p> <hr>`;
// divEl.innerHTML = `<p>Which German city is famous for the perfume it produces?</p> <p><input id="qnTwo" type="text"></p> <p id="feedback2" ></p> <hr>`;
// divEl.innerHTML = `<p>How many events are there in a decathlon?</p> <p><input id="qnThree" type="text"></p> <p id="feedback3" ></p> <hr>`;
// divEl.innerHTML = `<p>Which is the only mammal that cannot jump</p> <p><input id="qnFour" type="text"></p> <p id="feedback4" ></p> <hr>`;
// divEl.innerHTML = `<p>India is a part of which continent?</p> <p><input id="qnFive" type="text"></p> <p id="feedback5" ></p> <hr>`;
// function btnClicked() {
